package exercises.seventh_class.dual_pivot_quicksort;

import exercises.fourth_class.AuxiliarClass;
import sorting_methods.dual_pivot_quicksort.DualQuicksort;
...
public class Main {
    public static void main(String[] args) {
        ...
        final String ROOT_PATH_SORTED_DATA = "src/exercises/seventh_class/dual_pivot_quicksort/sorted_data/";
...
//        File with 5 numbers.
        ...
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados5.txt", numbers, DualQuicksort.getReport());
//    ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados100.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados1000.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados10_mil.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados50_mil.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados100_mil.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        DualQuicksort.sort(numbers);
        System.out.println(DualQuicksort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados500_mil.txt", numbers, DualQuicksort.getReport());
//     ----------------------------------------------------------------------------------------------------
    }
}
