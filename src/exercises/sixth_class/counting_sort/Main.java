...
public class Main {
    public static void main(String[] args) {
        ...
        final String ROOT_PATH_SORTED_DATA = "src/exercises/sixth_class/counting_sort/sorted_data/";
        ...
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados5.txt", numbers, CountingSort.getReport());
        //    ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados100.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados1000.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados10_mil.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados50_mil.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados100_mil.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
        System.out.println("----------------------------------------------------------------------");
        ...
        CountingSort.sort(numbers);
        System.out.println(CountingSort.getReport());
        AuxiliarClass.recordInfoIntoFile(ROOT_PATH_SORTED_DATA + "dados500_mil.txt", numbers, CountingSort.getReport());
//     ----------------------------------------------------------------------------------------------------
    }
}
