package exercises.third_class.comb_sort.factor_two;
...
public class Main {
    public static void main(String[] args) {
        ...
        final String ROOT_PATH_SORTED_DATA = "src/exercises/third_class/comb_sort/factor_two/sorted_data/";
        int[] numbers; //Array to contain all numbers gotten from the files with unsorted data.
        System.out.println("Comb Sort Factor 2 Ordination");
        System.out.println("----------------------------------------------------------------------");
//        File with 5 numbers.
